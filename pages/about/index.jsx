...
export const aboutData = [
  ...
  },
  {
    ...
    info: [
      {
        title: "Bext Employee Of the  Year Award",
        stage: "2023 - 2024",
      }
...
const About = () => {
  ...
  return (
    <div className="h-full  py-32 text-center xl:text-left    ">
      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6    xl:pt-[250px]">
        {/* text */}
...
I’m a web designer and developer with expertise in creating seamless digital experiences. Using technologies like React.js, Laravel, and Tailwind CSS, I transform ideas into functional and visually appealing websites.
        ...
        <motion.div
          ...
          animate="show"
          exit="hidden"
          className="flex flex-col w-full xl:max-w-[48%] h-[480px] pb-[100px] lg:pb-[0px]"
        >
